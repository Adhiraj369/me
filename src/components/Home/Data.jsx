...
const Data = () => {
    return(
        ...
        <div className="home__data">
            <h1 className="home__title">Adhiraj Singh
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">I'm a Developer</h3>
            <p className="home__description">I'm a creative developer currently studying in IIIT NAGPUR </p>
